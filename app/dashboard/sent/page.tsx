  ...
  return (
    <div className="px-6 py-8 max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center bg-accent-light">
          <Send size={17} className="text-accent" />
        </div>
        <div>
          <h1 className="text-xl font-bold text-primary">送信トレイ</h1>
          <p className="text-xs text-muted">あなたが送った質問と返信</p>
        </div>
      </div>
